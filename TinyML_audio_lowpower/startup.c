...
#define GENERIC_CLOCK_GENERATOR_XOSC32K   (5u) // [rdp] was 1u
#define GENERIC_CLOCK_GENERATOR_OSC32K    (5u) // [rdp] was 1u
#define DFLL48M_CLOCK_SOURCE GCLK_CLKCTRL_GEN_GCLK5 // [rdp] ws GCLK1
...
void SystemInit( void )
{
  ...
  /* ----------------------------------------------------------------------------------------------
   * 2) Put XOSC32K as source of 32KHz Generic Clock Generator
   */
  ...
  /* Write 32KHz Generic Clock Generator configuration */
...
#endif
                      GCLK_GENCTRL_OE |          // [rdp] Output 32KHz clock to drive NDP101
                      GCLK_GENCTRL_RUNSTDBY |    // [rdp] Run in standby mode.
                      GCLK_GENCTRL_GENEN ;
  ...
  /* ----------------------------------------------------------------------------------------------
   * 3) Put 32KHz Generic Clock Generator as source for Generic Clock Multiplexer 0 (DFLL48M reference)
   */
  GCLK->CLKCTRL.reg = GCLK_CLKCTRL_ID( GENERIC_CLOCK_MULTIPLEXER_DFLL48M ) | // Generic Clock Multiplexer 0
                      DFLL48M_CLOCK_SOURCE | // Set source to 32KHz GCLK [rdp]
                      GCLK_CLKCTRL_CLKEN ;
